...
/** Official Google Play logo (multicolor, from Google brand asset) */
export function IconGooglePlay({ className = 'h-5 w-5' }) {
  return (
    <img
...
export function IconDiscord({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function IconLogo({ className = 'w-8 h-8' }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" aria-hidden="true">
      <rect width="32" height="32" rx="8" className="fill-studio-accent" />
      <path
        d="M8 20L16 8l8 12H8z"
        fill="white"
        fillOpacity="0.9"
      />
      <circle cx="16" cy="18" r="2" fill="#6366f1" className="dark:fill-studio-night" />
    </svg>
  );
}
